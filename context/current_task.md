...
- `context/activity_log.jsonl` (32 touches)
- `context/current_task.md` (32 touches)
- `context/flowmap.json` (32 touches)
- `context/flowmap.md` (32 touches)
- `context/state.json` (32 touches)
- `context/watchlist.json` (32 touches)
- `store.js` (15 touches)
